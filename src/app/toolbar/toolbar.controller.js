(function ()
{
  ...
  /** @ngInject */
  function ToolbarController(AuthService, localStorageService, $rootScope, $q, $state, $timeout, $mdSidenav, $translate, $mdToast, msNavigationService)
  {
    var vm = this;

    // Data
    vm.currentUser = localStorageService.get("fN");
    ...
    function changeLanguage(lang)
    {
      ...
      if ( lang.code !== 'en' )
      {
        var message = 'BrillantPay supports translations, but currently we do not have any translations other than English language. If you want to help us, send us a message through our contact page.';
