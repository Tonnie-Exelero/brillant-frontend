(function ()
{
  ...
  /** @ngInject */
  function MsShortcutsController($scope, $cookies, $document, $timeout, $q, msNavigationService, PermPermissionStore)
  {
    var vm = this;
    ...
    function loadShortcuts()
    {
      ...
      var shortcuts = angular.fromJson($cookies.get('BRILLANTPAY.shortcuts'));
        ...
        shortcuts = [
          {
            ...
            '_id'         : 'profile',
            '_path'       : '',
            'uisref'      : 'app.user_profile',
            'hasShortcut' : true
          }
        ];

        $cookies.put('BRILLANTPAY.shortcuts', angular.toJson(shortcuts));
      }
